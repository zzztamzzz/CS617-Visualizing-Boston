...
output_file_path_pop_change = os.path.join(polished_dir, 'Boston_Population_Change.csv')
output_file_path_annual_change = os.path.join(polished_dir, 'Boston_Annual_Change.csv')
