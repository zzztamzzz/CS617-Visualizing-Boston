...
lhs = new JPlusAssignOp(line, lhs, rhs);
        ...
        case SUBTRACTION_ASSIGN:{
          jj_consume_token(SUBTRACTION_ASSIGN);
          rhs = assignmentExpression();
lhs = new JMinusAssignOp(line, lhs, rhs);
          break;
          }
        case PROD_ASSIGN:{
          jj_consume_token(PROD_ASSIGN);
          rhs = assignmentExpression();
...
lhs = new JARightShiftAssignOp(line, lhs, rhs);
        ...
        case LOGRSHIFT_ASSIGN:{
          jj_consume_token(LOGRSHIFT_ASSIGN);
          rhs = assignmentExpression();
...
lhs = new JGreaterThanOp(line, lhs, rhs);
        ...
        case GREAT_EQUAL:{
          jj_consume_token(GREAT_EQUAL);
          rhs = shiftExpression();
lhs = new JGreaterEqualOp(line, lhs, rhs);
          break;
          }
        case COMPARE_LESS:{
          jj_consume_token(COMPARE_LESS);
          rhs = shiftExpression();
...
{if ("" != null) return expr;}
 ...
 {
    if (jj_scan_token(LOGRSHIFT)) return true;
 ...
 {
    if (jj_scan_token(COMPARE_LESS)) return true;
    if (jj_3R_91()) return true;
    return false;
  }
 ...
 {
    if (jj_scan_token(GREAT_EQUAL)) return true;
    if (jj_3R_91()) return true;
    return false;
  }
 ...
 {
    if (jj_scan_token(LOGRSHIFT_ASSIGN)) return true;
    if (jj_3R_58()) return true;
    return false;
  }
 ...
 {
    if (jj_scan_token(PROD_ASSIGN)) return true;
    if (jj_3R_58()) return true;
    return false;
  }
 ...
 {
    if (jj_scan_token(SUBTRACTION_ASSIGN)) return true;
    if (jj_3R_58()) return true;
    return false;
  }
  ...
  private boolean jj_3_15()
 {
  ...
  static {
	...
	private static void jj_la1_init_2() {
	   jj_la1_2 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x872,0x872,0x872,0x872,0x872,0x872,0x0,0x0,0x0,0x872,0x0,0x0,0x0,0x872,0x0,0x872,0x0,0x0,0x0,0x872,0x0,0x872,0x0,0x872,0x0,0x0,0x0,0x0,0x0,0x5255c080,0x5255c080,0x200,0x80000000,0x4,0x20000000,0x8000000,0x0,0x1000,0x1000,0x4800009,0x4800009,0x1280000,0x1280000,0x60,0x60,0x22100,0x22100,0x872,0x10,0x800,0x0,0x2,0x2,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
	}
	private static void jj_la1_init_3() {
	   jj_la1_3 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x4,0x0,0x0,0x4,0x4,0x0,0x0,0x4,0x0,0x0,0x4,0x0,0x0,0x0,0x4,0x3704,0x3704,0x3704,0x3704,0x3704,0x3704,0x0,0x0,0x0,0x3704,0x0,0x4,0x0,0x3704,0x0,0x3704,0x0,0x0,0x0,0x3704,0x0,0x3704,0x0,0x3704,0x0,0x0,0x0,0x0,0x4,0x2,0x2,0x0,0x0,0x0,0x0,0x0,0x1,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x3704,0x0,0x3704,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x3704,0x4,0x0,0x0,0x0,0x3700,};
	}
